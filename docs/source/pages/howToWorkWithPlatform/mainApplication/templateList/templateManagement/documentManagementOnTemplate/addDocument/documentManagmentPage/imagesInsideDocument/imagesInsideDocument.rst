...
In this section described possibility to add images to document and restrictions related to images format and size.

How to add image to document?
=============================

If it's necessary to add image to document you have to do the following:
...
Image properties in the document
================================

* You can adjust image size in document
...
If it's necessary to delete image from document you can do it in three ways
...
3. Set cursor of mouse in front of the image and click "Delete" button on Windows or Linux
