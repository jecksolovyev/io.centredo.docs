...
3.In the input “Аpprover” and “Mailbox” (you can search mailbox by name or uuid) enter details of the approver and click on [Add] button. You can create unlimited quantity of approvers. You can delete approver by clicking on [Cancel] button.You can mark envelope with "Urgent" status(1), and you can et order for approvers(2).
...
6.To save route, input name for route and click [Save] button.

.. image:: pic_flow/Screenshot_5.png
     :width: 600
     :align: center

7.You can use saved routes.
...
9.After select route, click [Next] button.